...
| **13** | 0.13.0 ✅ | **Multi-leg option combos** | 5-strategy (VERTICAL/CALENDAR/DIAGONAL/STRADDLE/STRANGLE) preview→confirm flow. Net-debit/credit envelope, max-loss/profit, break-evens. CSRF nonce. Risk-gate `_check_combo_envelope`. Single/Multi-Leg toggle in TradeTicketModal. Real broker dispatch deferred to Phase 14. |
