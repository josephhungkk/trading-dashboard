...
mkdir -p backend/app/_generated/broker/v1 sidecar/_generated/broker/v1
: > backend/app/_generated/__init__.py
: > backend/app/_generated/broker/__init__.py
: > backend/app/_generated/broker/v1/__init__.py
: > sidecar/_generated/__init__.py
: > sidecar/_generated/broker/__init__.py
: > sidecar/_generated/broker/v1/__init__.py
...
sed -i 's|^from v1 import broker_pb2|from sidecar._generated.broker.v1 import broker_pb2|' \
  sidecar/_generated/broker/v1/broker_pb2_grpc.py
