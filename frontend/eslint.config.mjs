...
export default tsEslint.config(
  {
    ignores: [
      ...
      '**/*.d.ts',
      'src/stories/**',
      // Generated by `pnpm gen:types` from the backend OpenAPI snapshot.
      // ESLint --fix rewrites index signatures and drops parts of the file,
      // which causes CI's pnpm check:types-up-to-date drift gate to fail.
