...
Stub. Implementation: BARC GBP qty 1, far-from-market entry/SL/TP ->
POST /api/orders/bracket -> verify 3 broker_order_ids returned -> DELETE
parent -> verify all 3 cancel within 5s -> revert trade_enabled.
